...
**Danza**: espectáculos cuya identidad principal sea danza o ballet, incluso con repertorio clásico. Ballet, Alvin Ailey, *El Cascanueces* como representación de danza. La agenda es de eventos musicales, no de artes escénicas en general. La mera presencia de una compañía de danza, bailarines o coreografía en un concierto no convierte el evento en espectáculo de danza cuando hay un bloque musical clásico sustancial, autónomo e identificable.

**Cine / proyecciones**: películas, cine familiar, cine mudo con acompañamiento, ciclos cuya actividad principal sea ver una película. Si excepcionalmente la componente principal es una **interpretación musical clásica en directo** —por ejemplo un concierto o recital de órgano que usa la proyección como soporte—, no asumir exclusión automática: evaluar el detalle. Una proyección con banda sonora o «música en vivo» genérica sigue fuera.
