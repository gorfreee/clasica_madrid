...
console.log(
  `Escrito: ${outputPath} (${catalog.events.length} eventos, ${catalog.venues.length} lugares, ${catalog.organizers.length} organizadores, ${catalog.series.length} series, ${catalog.sources.length} fuentes)`,
);
