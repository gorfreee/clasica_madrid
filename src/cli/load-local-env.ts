...
export const LOCAL_AI_ENV_KEYS = [
  ...
  'VERCEL_MODELS',
  'VERCEL_FREE_TIER_CONFIRMED',
  'VERCEL_MODEL_RPM',
  'VERCEL_MODEL_TPM',
  'VERCEL_MODEL_RPD',
  'VERCEL_MODEL_MAX_CONCURRENT',
  'VERCEL_MODEL_MIN_INTERVAL_MS',
  'VERCEL_MAX_CONCURRENT',
  'VERCEL_MIN_INTERVAL_MS',
  'VERCEL_RPD',
  'KILO_API_KEY',
  'KILO_MODELS',
  'KILO_FREE_TIER_CONFIRMED',
  'KILO_MODEL_RPM',
  'KILO_MODEL_TPM',
  'KILO_MODEL_RPD',
  'KILO_MODEL_MAX_CONCURRENT',
  'KILO_MODEL_MIN_INTERVAL_MS',
  'KILO_MAX_CONCURRENT',
  'KILO_MIN_INTERVAL_MS',
  'KILO_RPD',
  'OPENROUTER_API_KEY',
  'OPENROUTER_MODELS',
  'OPENROUTER_FREE_TIER_CONFIRMED',
  'OPENROUTER_MODEL_RPM',
  'OPENROUTER_MODEL_TPM',
  'OPENROUTER_MODEL_RPD',
  'OPENROUTER_MODEL_MAX_CONCURRENT',
  'OPENROUTER_MODEL_MIN_INTERVAL_MS',
