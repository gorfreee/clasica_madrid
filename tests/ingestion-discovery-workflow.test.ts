...
const AI_POOL_PREFIX = /^(AI_|GEMINI_|GROQ_|MISTRAL_|ZAI_|CLOUDFLARE_)/;
const FUTURE_PROVIDER_SUFFIX =
  /_(API_KEY|API_TOKEN|ACCOUNT_ID|MODELS|MODEL_RPM|MODEL_TPM|MODEL_RPD|MODEL_MAX_CONCURRENT|MODEL_MIN_INTERVAL_MS|MAX_CONCURRENT|MIN_INTERVAL_MS|FREE_TIER_CONFIRMED|FREE_MODE_CONFIRMED|WORKERS_FREE_CONFIRMED)$/;
